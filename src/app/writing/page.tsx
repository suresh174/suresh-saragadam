...
export const metadata: Metadata = {
  title: "Notes",
  description:
    "Learning notes and teaching posts from Suresh Saragadam — AI Explorer, Fraud Check, and production AI engineering.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
      ...
      <p className="mt-5 text-lg leading-relaxed text-ink-soft">
        Plain-English notes on what ships — with a lab you can follow when the
        code is ready.
      </p>
