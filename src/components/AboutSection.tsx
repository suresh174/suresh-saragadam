  ...
  return (
    <section id="about" className="scroll-mt-24 px-5 py-16 sm:px-8 sm:py-20">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-12">
        <Reveal className="relative mx-auto w-full max-w-[260px] sm:max-w-sm lg:mx-0 lg:sticky lg:top-28">
          <div className="overflow-hidden rounded-[1.75rem] bg-white shadow-[0_24px_60px_rgba(19,34,56,0.1)] ring-1 ring-line">
            <Image
              src={profile.photo}
              alt={`${profile.name}, AI Engineer`}
              width={640}
              height={800}
              className="aspect-[4/5] h-auto w-full object-cover object-[50%_12%]"
        ...
        <Reveal delayMs={80}>
          ...
          <p className="mt-5 max-w-2xl text-base font-light leading-relaxed text-ink-soft">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <div className="rounded-[1.5rem] bg-sea-deep px-6 py-7 text-foam">
              <p className="mono-label !text-[rgba(212,160,23,0.9)]">Education</p>
              <h3 className="mt-3 font-[family-name:var(--font-display)] text-2xl font-bold">
                {education.degree}
              </h3>
              <p className="mt-2 text-sm font-light text-foam/80">
                {education.school} · {education.location}
              </p>
              <p className="mt-1 text-sm font-light text-foam/70">
            ...
            <div className="rounded-[1.5rem] border border-line bg-white/55 p-6 backdrop-blur-sm">
              ...
              <ul className="mt-4 space-y-3 text-sm font-light text-ink-soft">
